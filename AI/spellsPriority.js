...
function botElementalist(){
    ...
    fireballTarget = hasCardDefence(playerFields, 1);
    if(fireballTarget){
        fireballPriority = 5;
    ...
    chainLightTarget = hasCardDefence(playerFields, 2, chainLightTarget);
    ...
    stoningTarget = hasCardDefence(playerFields, 2, stoningTarget);
