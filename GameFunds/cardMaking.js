// importing
    var variables = require('../AI/mainLogic');
...
exports.Card = function(mana, attack, defence, special, name){
    ...
    this.initialHealth = JSON.parse(JSON.stringify(defence));;
    this.name = name;
...
exports.allCards = [
        new this.Card(0, 100, 123213, '', 'Mama'), 
        ...
        new this.Card(4, 2, 3, 'Battlecry: Shadowstep an enemy field;', 'Pickpocket Master'),
...
exports.defineUniq_Cards = function(){
    uniqCards.push('Veteran Fleshreaver','Captain Tervelan', 'Kamikazeto99',  
                   'Vyacheslav','The Destroyer of Worlds');
}   